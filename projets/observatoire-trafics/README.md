...
**État : Kanban en cours d'intégration.**
...
d'abord par copier-coller dans le Custom Widget Builder de Grist. Il sera intégré
à ce dépôt dans `widgets/kanban/`, puis généralisé pour servir à d'autres
projets de l'espace.
