...
**État : Kanban intégré au dépôt (version d'origine), testé par URL le 2026-09-24.**
...
Un Kanban de suivi des tâches a été développé par Rémi ([@Rmemb](https://github.com/Rmemb), CDD) pour ce projet,
